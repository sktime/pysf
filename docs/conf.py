...
# -*- coding: utf-8 -*-
#
# pysf documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pysf.tex', 'pysf Documentation',
     'Ahmed Guecioueur', 'manual'),
]
...
man_pages = [
    (master_doc, 'pysf', 'pysf Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pysf', 'pysf Documentation',
     author, 'pysf', 'One line description of project.',
     'Miscellaneous'),
]
